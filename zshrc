...
export ZSH=/Users/sssang/.oh-my-zsh
...
plugins=(git python pip autojump zsh-syntax-highlighting osx history history-substring-search)

# User configuration

export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:$HOME/Desktop/douban/dae/venv/bin"
...
# alias ls="ls -G"
# alias dou="ssh sangsuyu@doubandev2"
